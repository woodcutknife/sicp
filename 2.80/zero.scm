...
(display (=zero? (make-scheme-number 10)))
(display (=zero? (make-scheme-number 0)))
(display (=zero? (make-rational 1 1000000000)))
(display (=zero? (make-rational 0 -1)))
(display (=zero? (make-complex-from-real-imag 0 0)))
(display (=zero? (make-complex-from-real-imag 0.01 0)))
(display (=zero? (make-complex-from-mag-ang 0.1 0)))
(display (=zero? (make-complex-from-mag-ang 0 3.1)))
